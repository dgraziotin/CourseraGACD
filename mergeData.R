mergeData <- function( dataDir ) {

    ## Load the training data

    train.input.file   <- file.path( dataDir, "train","X_train.txt" )
    train.output.file  <- file.path( dataDir, "train","y_train.txt" )
    train.subject.file <- file.path( dataDir, "train","subject_train.txt" )
    ...
    test.input.file   <- file.path( dataDir, "test","X_test.txt" )
    test.output.file  <- file.path( dataDir, "test","y_test.txt" )
    test.subject.file <- file.path( dataDir, "test","subject_test.txt" )
